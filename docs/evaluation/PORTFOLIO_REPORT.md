...
Citation correctness means every accepted citation points to evidence retrieved for the same authenticated actor and realm. The grounded-answer rate means every deterministic answer passed the external claim-and-citation validator; it is not a claim that a generative model has perfect semantic faithfulness.
