...
The terms in this document are used consistently in product documentation, APIs, code, tests, and user-facing copy. New synonyms should not be introduced casually.
...
The top-level knowledge and authorization boundary. During the MVP, a realm may represent either a fictional world or a specific campaign. A future world-to-campaign hierarchy is deliberately not modelled yet.
