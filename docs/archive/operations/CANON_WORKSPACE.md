...
M9 adds **Atlas del canon**, a browser interface for the M6 catalogue. Users can create, review, and promote
records without Ollama or installed model weights.
...
4. Review the description, policy, and evidence, then choose **Promover a canon**.
5. Open **Relaciones**, choose two existing entities, name the directional claim, and repeat the evidence and promotion
   workflow.

Editing a canonical record returns it to **Propuesto**. Deleting an entity with active relations is
