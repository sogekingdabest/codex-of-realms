...
Codex of Realms stores notes for fictional worlds and tabletop campaigns. Users can ask questions about those notes and receive cited answers based on sources they are allowed to read. The system refuses to answer when it cannot find enough evidence.
...
The design combines four requirements:
